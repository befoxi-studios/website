  ...
  render() {
    ...
    return (
      ...
      `}>
        ...
        <div class='grid grid-cols-[0_100dvw] min-[22rem]:grid-cols-[1fr_21rem] gap-1'>
          <div class='flex flex-row gap-2 m-2 mt-0'>
            <div class='relative flex items-center justify-center p-0'>
              <div class={cn`
                relative min-w-screen md:min-w-lg h-full bg-neutral-950 border border-neutral-200/3
          ...
          <div class={cn`
            relative m-2 mt-0 h-[calc(100dvh-60px-(var(--spacing)*2))]
